...
def __stats_test_per_value(values1,values2,
                   test,**test_kws):
...
def two_group_test(data,
                        test_variable,
                        comparisons=None,
                        ref_group=None,
                        test='ttest_ind', test_kws=None,
    ...
    if type(test)==str:
        ...
        if test in ['ttest_ind']:
            ...
            Test= lambda values1,values2: __stats_test_all_on_once(values1,values2,scipy_test,**test_kws)

        else:
            Test= lambda values1,values2: __stats_test_per_value(values1,values2,scipy_test,**test_kws)
    ...
    if ref_group is not None:
        assert ref_group in Groups, "ref_group: {} is not in the groups: {}".format(ref_group,Groups)
...
def calculate_stats(data,
    ...
    kws= dict( test_variable= test_variable,
                ref_group=ref_group,
